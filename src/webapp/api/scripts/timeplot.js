...
Timeplot.createPlotInfo = function(params) {
    return {   
        ...
        eventOnClick:      ("eventOnClick" in params) ? params.eventOnClick : null,
        eventOnMouseOver:  ("eventOnMouseOver" in params) ? params.eventOnMouseOver : null,
        eventOnMouseOut:   ("eventOnMouseOut" in params) ? params.eventOnMouseOut : null,
